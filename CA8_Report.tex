...
\title{Multivariable Control of a Reefer Trailer}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{\textbf{CA8 Group 834} \\\vspace{1mm} 	Martin Højlund Therkildsen\\\vspace{0.01mm}
		Rasmus Løvschall Kristiansen \\\vspace{0.01mm}
		Kasper Laustsen} \\\vspace{3mm}
...
Email: \href{mailto: es-22-ca-8-834@student.aau.dk}{es-22-ca-8-834@student.aau.dk}} \\\vspace{2mm}
\textbf{Supervisors}\\
John-Josef Leth \\
Jan Dimon Bendtsen
}
...
\input{Chapters/Modeling_ComponentModels}

\newpage
\subsection{System Model} \label{sec:mod_collec}
\input{Chapters/Modeling_CollectionOfComponents}

\newpage
\subsection{Obtaining a Linear System Model} \label{sec:mod_lin}
\input{Chapters/Modeling_Linearisation}

% CONTROLLER DESIGN
% ---------------------------
\section{Controller Design} \label{sec:ctrl}
\input{Chapters/ControllerDesign}

% ROBUSTNESS OF CONTROLLER
% ---------------------------
\clearpage
\newpage
\section{Robustness Analysis} \label{sec:rob-ctrl}
...
\clearpage
\newpage
\section{Test - Linear Controller on Linear Model} \label{sec:test-sim}
\input{Chapters/TestSimulation}

% TEST - REAL SYSTEM
% ---------------------------
\clearpage
\newpage
\section{Test - Linear Controller on HiFi Simulation Model} \label{sec:test-real-sys}
\input{Chapters/TestReal}
...
\input{Chapters/Documentation_newModel}
\clearpage
\input{Chapters/Documentation_tj00}
\clearpage
\input{Chapters/Documentation_tj01}
\clearpage
