...
\todo[inline]{insert new A, B and C}
...
These matrices constitute the linear state space model of the system. To more easily keep track of the model changes a table is provided for each model iteration. The first of such a table is seen in \cref{tab:model_full}. [A$|$B] Denotes controllability matrix and [A$|$C] denotes observability matrix.
