...
In \cref{eq:taylor} the partial derivatives become Jacobian matrices and $f(\textbf{x}_o, \textbf{u}_o, \textbf{d}_o) = 0$ because the linearisation is done at an EQUILIBRIAN.
