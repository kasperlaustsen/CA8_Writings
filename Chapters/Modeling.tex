...
\begin{center}
	\begin{tabular}{l p{8cm} l}
		...
		$Q_{rm}$					& Heat flow: Refrigerant to metal			& [\si{W}] \\
		$Q_{ma}$					& Heat flow: Metal to ambient						& [\si{W}] \\
...
\begin{align}
	...
	\dot{m}_{out}		& = \dot{m}_{in} + \frac{M_r - \frac{V_i}{v}}{1s}
\end{align}
...
\begin{center}
	\begin{tabular}{l p{8cm} l}
		...
		$\lambda$				& Pressure drop ratio 						& [\si{bar}\si{s}/\si{kg}] \\
		$V_i$						& Condenser internal volume				& [$\si{m}^3$] \\
		$v$							& Refrigerant specific volume 			& [$\si{m}^3/\si{kg}$]
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{l p{8cm} l}
		$U A_{rm}$			& Overall heat transfer coefficient: Refrigerant to metal		& [\si{W}/\si{K}] \\
		$U A_{ma}$			& Overall heat transfer coefficient: Metal to ambient			& [\si{W}/\si{K}] \\
		$U_{fan}$				& Condenser fan speed										& [\si{\si{rad}/\si{s}}] \\
		$T_r$						& Temperature of output refrigerant  					& [\si{K}] \\
		$T_a$					& Temperature of air blown over condenser coil		& [\si{K}] \\
