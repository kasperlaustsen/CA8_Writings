...
\begin{center}
	\begin{tabular}{l p{10cm} l}
		...
		$U_{fan}$			& Fan speed 			& [rad/s ???? \todo{unit? look in datasheet}] \\
		...
		$Cp_{air}$			& Specific heat capacity of air			& [] \\	
		...
		$UA_3$				& Heat transfer coefficient from metal surrounding vapor CV to metal surrounding liquid-vapor CV?? \todo{hjælp}			& [\si{J}/\si{K}] \\
	\end{tabular}
\end{center}
