...
The heat flows and temperatures relating to the evaporator is modeled by the following equations. The heat flow from air to  metal of evaporator is modeled based on the assumption that the mass flow of air is cooled down to the metal temperature in \cref{eq:Q_amv} and \cref{eq:Q_aml}. \cref{eq:Q_fan_heatloss} \todo[inline]{correct this equation} are the heat losses from the fan that is being added to the air flow. \cref{eq:Q_mvml}, \cref{eq:Q_ml} and \cref{eq:Q_mv} all model convection heat flows.
