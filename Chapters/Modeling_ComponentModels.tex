...
\todo[inline]{Add descriptions of variables}
...
\todo[inline]{John asked if the denominator of eq 35 should be equal to zero? }
...
\todo[inline]{P(t) = P and F(P) not F(P(t))}
\todo[inline]{Lookup skal defineres inden eq 36}
...
\todo[inline]{Sæt flere ord på ovenstående ligninger}
...
\todo[inline]{Ret equation numre på arrows}
