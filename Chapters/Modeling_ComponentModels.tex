...
\begin{center}
	\begin{tabular}{l p{8cm} l}
		...
		$\Phi$ 		& TPH; Table lookup of the vapor refrigerant temperature from pressure and enthalpy & [\si{K}]
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{l p{8cm} l}
		...
		$\mathcal{Z}$        & Table lookup of specific volume from enthalpy and pressure & []
	\end{tabular}
\end{center}
