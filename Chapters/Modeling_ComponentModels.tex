...
\begin{center}
	\begin{tabular}{l p{8cm} l}
		$M(p)$			&  Lookup table of the specific enthalpy of saturated liquid	at pressure p		& [\si{J}/\si{kg}]\\
		$N(p)$			&  Lookup table of the specific enthalpy of saturated vapour	at pressure p		& [\si{J}/\si{kg}] \\
...
The return air temperature which is located before the evaporator fan is equal to the
