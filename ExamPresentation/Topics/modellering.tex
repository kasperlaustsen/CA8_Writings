\begin{frame}{Modelling}{Introduction}
	A first principle model of the refrigeration system is derived, linearised and further developed for observer based control.
	\begin{itemize}
...
\begin{frame}{Modelling}{Component Models}
	...
	\begin{itemize}
		...
		\item Box
	\end{itemize}
	Only the most important or relevant equations are included here.
\end{frame}
...
\begin{frame}{Modelling}{Compressor}
	...
	\begin{itemize}
		...
		\item Difference: Stage 2 has half the internal volume of stage 1
...
\begin{frame}{Modelling}{Flash tank}
	\textbf{Purpose:} Separate flash gas and liquid refrigerant after condenser throttle valve (CDV).
	\begin{itemize}
	...
	\begin{itemize}
		...
		\item Pressure/flow input/output setup leads to problems
			\begin{itemize}
				...
				\item Input and output pressure is constant
			\end{itemize}
	\end{itemize}
\end{frame}
