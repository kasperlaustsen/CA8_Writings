...
\title[Multivariable Control of A Reefer Trailer]% optional, use only with long paper titles
{Multivariable Control of A Reefer Trailer}

\subtitle{Cooperation with BITZER Electronics A/S}  % could also be a conference name
